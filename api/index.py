...
class Server:
    def __init__(self):
        ...
        @self.app.route('/get-skins', methods=['POST'])
        def get_skins():
            try:
        ...
        @self.app.route('/get-common', methods=['POST'])
        def get_common():
            try:
        ...
        @self.app.route('/version', methods=['POST'])
        def version():
            data = request.json
            if data['code'] == 15142:
        ...
        @self.app.route('/create_key', methods=['POST'])
        def create_key():
            data = request.json
        ...
        @self.app.route('/admins', methods=['GET'])
        def admins():
